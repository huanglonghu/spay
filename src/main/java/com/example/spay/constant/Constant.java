package com.example.spay.constant;
...
public class Constant {
    ...
    public static String baseUrl = "http://www.zxylonline.com:8011";
    public static String headImageUrl;
    public static String payUrl;
    public static String webSocketUrl = "http://www.zxylonline.com:8027";
